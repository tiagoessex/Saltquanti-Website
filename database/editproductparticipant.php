    ...
    <form id="reg_form">
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                ...
                <input type="text" class="form-control is-valid" placeholder="ID" value="<?php echo $_GET['id']; ?>" required disabled>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // load and insert categories list
    ...
    function UpdateProduct() {
        ...
        $.ajax({
            url: "database/updateproductandinvalid.php",
            method: "POST",
    ...
    // check if each category is a pre-defined one
    ...
    // every action on the categories' input => validate content
    ...
    // from the categories tree to the categories input fields
    function Accept() { 
       if (path[0] != undefined) {
            $('#category').val(path[0]);
