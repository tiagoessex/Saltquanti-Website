            ...
            <fieldset>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"> 
                        ...
                        <button type="reset" class="btn" value="Reset"> Limpar </button>
                    </div>
                </div>
            </fieldset>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center" id="msg">
                        <h4>Informações submetidas com sucesso.</h4>
                        <div class="text-justify">
                            <p>Poderá aceder à sua conta e submeter novos produtos assim que for validado por um administrador.</p>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" id="modal-btn"><span class="glyphicon glyphicon-ok"></span> Ok</button>
                    </div>
                </div>
            </div>
        </div>
