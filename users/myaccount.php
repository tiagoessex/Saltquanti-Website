...
<?php
    $link = db_start();
    $sql = 'SELECT * from  ' . DB_TABLE_USERS . ' where username like "'. $_SESSION['username'] . '" LIMIT 1';
    ...
    <div class="col-md-12">
        ...
        <form class="form-horizontal"   id="reg_form">
            ...
            <fieldset>
                <div class="form-group has-feedback">
                    ...
                    <div class="col-md-6  inputGroupContainer">
                        <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="username" placeholder="Nome de utilizador" class="form-control" type="text" id="username" required disabled value = "<?php echo $row['username']; ?>" >
                        </div>
                    </div>
                </div>
                <div class="form-group has-feedback">
                ...
                <div class="form-group has-feedback">
                    <label for="confirmPassword"  class="col-md-4 control-label">Confirmar Password</label>
                    <div class="col-md-6  inputGroupContainer">
                        <div class="input-group"> 
                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                            <input class="form-control {$borderColor}" id="userPw2" type="password" placeholder="Confirmar password" name="confirmPassword" data-match="#confirmPassword" data-minLength="5" data-match-error="some error 2" required value = "<?php echo $row['password']; ?>" >
                            <span class="glyphicon form-control-feedback"></span>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
            ...
            <fieldset>
                <div class = "row">
                    ...
                    <div class="col-md-9">
                        <legend> Informação Pessoal <span style="font-size:75%;">(Opcional)</span> </legend>
                    </div>
                </div>
                <!-- Text input-->
                    ...
                    <div class="col-md-6 selectContainer">
                        <div class="input-group">
                            ...
                            <select name="country" class="form-control selectpicker" >
                                ...
                                <option value="Portugal" <?php echo ($row['country'] == "Portugal"? "selected" : "" ); ?> > Porto Rico</option>
            ...
            <fieldset>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"> 
                        <button type="submit" class="btn btn-primary btn-block" id = "submit"><span class="glyphicon glyphicon-save"></span>  Actualizar </button>
                    </div>
                    <div class="col-md-2"> 
                        <button type="button" class="btn btn-danger btn-block" id = "delete"><span class="glyphicon glyphicon-remove"></span>  Apagar </button>
                    </div>
                </div>
            </fieldset>
        </form>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center" id="msg">
                        <h4>A sua conta foi actualizada com sucesso.</h4>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" id="modal-btn">Close</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="myModalDelete" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center" id="msg">
                        <h4>Têm a certeza que deseja eliminar a sua conta?</h4>
                        <p class="text-justify">
                            Ao apagar a sua conta, apenas os seus dados serão eliminados.
                            Todos os produtos inseridos / actualizados por si, <strong>não serão afectados</strong>.
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" id="modal-btn-cancel">Não</button>
                        <button type="button" class="btn btn-danger" data-dismiss="modal" id="modal-btn-delete">Sim</button>                        
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).on('click', '#modal-btn', function(e){
        window.location.href="users/myaccount.php";
    });
